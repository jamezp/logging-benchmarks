 ...
 */
public class SizeRotatingFileHandlerBenchmark extends AbstractFileRotationBenchmark {
    ...
    protected FileHandler createFileHandler(final Path tempLogFile) throws FileNotFoundException {
        return new SizeRotatingFileHandler(tempLogFile.toFile(), false, rotationSize, 10);
    }
}
