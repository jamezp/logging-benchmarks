...
package org.jboss.annotation.processor;
 ...
 * <p/>
 * <b>Note:</b> The protected global variables should only be accessed from the {@link #process(Set,
 * javax.annotation.processing.RoundEnvironment)} method. These variables are initialized in the {@link
 * #init(ProcessingEnvironment)} method and are subject to the contract set forth by the
